...
* Anzeige von Statistiken pro Tour (Distanz, Fahrzeit, Servicezeit, Gesamtdauer) und globale Kennzahlen (Anzahl Touren, Durchschnittliche Stops).
* Download‑Funktion: Jede Tour kann als CSV‑Datei heruntergeladen werden – so erhalten Sie eine digitale Route zum Weitergeben.
