...
# Verschiebt veraltete Dokumentationsdateien nach docs/archive/

$archiveDir = "docs\archive\consolidated_2025-11-13"
$docsDir = "docs"

# Erstelle Archiv-Verzeichnis
if (-not (Test-Path $archiveDir)) {
    New-Item -ItemType Directory -Path $archiveDir -Force | Out-Null
    Write-Host "[OK] Archiv-Verzeichnis erstellt: $archiveDir"
}

# Liste der zu archivierenden Dateien (aus ARCHIVE_PLAN.md)
$filesToArchive = @(
    ...
    "Api_Docs.md",
    "api_tourplan_match.md",
    "api_tourplan_geocode_missing.md",
    "api_manual_geo.md",
    ...
    # Veraltete Status/Changelog-Dateien
...
Write-Host "`n============================================================"
Write-Host "Dokumentations-Archivierung"
Write-Host "============================================================`n"
...
foreach ($file in $filesToArchive) {
    ...
    if (Test-Path $sourcePath) {
        try {
            ...
            Write-Host "[OK] Archiviert: $file"
            $moved++
        } catch {
            Write-Host "[FEHLER] Konnte nicht verschieben: $file - $_"
            $errors++
        }
    } else {
        Write-Host "[INFO] Nicht gefunden: $file (bereits archiviert oder nicht vorhanden)"
        $notFound++
    }
}
...
Write-Host "============================================================"
Write-Host "Archiviert: $moved Dateien"
Write-Host "Nicht gefunden: $notFound Dateien"
Write-Host "Fehler: $errors Dateien"
Write-Host "`nArchiv-Verzeichnis: $archiveDir"
Write-Host "============================================================`n"
