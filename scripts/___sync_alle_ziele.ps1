...
$FilesToSync = @(
    ...
    "docs\FIXPLAN_500_ERROR_IMPLEMENTIERT.md",
    "docs\CHECKLIST_POST_FIX.md",
    "docs\FEHLER_ZUSAMMENFASSUNG_500_ERROR.md",
    "docs\STATUS_MASTER_PLAN_2025-01-10.md",
    "docs\FIXES_2025-01-10_SPAET.md",
    "docs\Architecture.md",
    "backend\middlewares\error_envelope.py",
    "backend\middlewares\trace_id.py",
    "routes\schemas.py",
    "routes\tourplan_match.py",
    "routes\workflow_api.py",
    "tests\test_subroutes_500_fix.py"
)
