...
def test_bulk_process_api_endpoint(mock_tourplaene_dir, mock_geo_repo, mock_geocode_address, client):
    ...
    import backend.routes.tourplan_bulk_process as bulk_module
    import os
...
def test_bulk_process_db_first_strategy(mock_tourplaene_dir, mock_geo_repo, mock_geocode_address):
    ...
    import asyncio
    from backend.routes.tourplan_bulk_process import bulk_process_all_csv
    ...
    with patch("backend.routes.tourplan_bulk_process.parse_tour_plan_to_dict", return_value=mock_tour_data):
        with patch("backend.routes.tourplan_bulk_process.Path") as mock_path:
            # Mock tourplaene-Verzeichnis
...
def test_bulk_process_error_handling(client, monkeypatch):
    ...
    with patch("backend.routes.tourplan_bulk_process.Path", side_effect=mock_path_not_exists):
        response = client.post("/api/tourplan/bulk-process-all")
